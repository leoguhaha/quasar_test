    ...
    <div class="left">
      ...
      <fieldset class="login">
        ...
        <table cellpadding="0" cellspacing="3" border="0">
          <tr>
            <td class="tt">IP地址</td>
            <td><input id="loginip" type="text" class="txt" value="10.20.0.122" /></td>
          ...
          <tr>
            ...
            <td class="tt">密码</td>
            <td><input id="password" type="password" class="txt" value="Asb11023" /></td>
        ...
        <table cellpadding="0" cellspacing="3" border="0">
          ...
          <tr>
            <td colspan="4"><input type="button" class="btn" value="获取" onclick="clickGetLocalCfg();" />&nbsp;<input
                type="button" class="btn" value="设置" onclick="clickSetLocalCfg();" />&nbsp;&nbsp;修改参数后，需要刷新界面后生效。</td>
          </tr>
        </table>
      </fieldset>
    </div>
          ...
          <tr>
            ...
            <td>
              <input type="text" id="volume" class="txt" value="50" maxlength="3" />&nbsp;<input type="button"
                class="btn" value="设置" onclick="clickSetVolume();" />（范围：0~100）
            </td>
            <td>
          ...
          <tr>
            <td>
              <input id="upgradeFile" type="text" class="txt" />&nbsp;<input type="button" class="btn" value="浏览"
                onclick="clickOpenFileDlg('upgradeFile', 1);" />&nbsp;<input type="button" class="btn2" value="升级"
...
async function loadScriptsInOrder() {
  try {
    ...
    const videoControlInstance1 = new VideoControl('divPlugin', '10.20.0.122', '80', 'admin', 'Asb11023', WebVideoCtrl);
...
const portOptions = ref([
  // Placeholder for device port options
]);
...
// Additional option arrays as necessary
...
function clickGetLocalConfig() {
  // Implement config retrieval logic here
}

function clickSetLocalConfig() {
